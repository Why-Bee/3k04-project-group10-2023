...
class SignupWindow(QMainWindow): 
    ...
    def create_programmable_parameters_AOO(self, id, c): # create programmable parameters for new user
        c.execute('INSERT INTO AOO_lower_rate_limit (id, value) VALUES (?, ?)', (id, 60))
        c.execute('INSERT INTO AOO_upper_rate_limit (id, value) VALUES (?, ?)', (id, 120))
        c.execute('INSERT INTO AOO_atrial_amplitude (id, value) VALUES (?, ?)', (id, 35))
        c.execute('INSERT INTO AOO_atrial_pulse_width (id, value) VALUES (?, ?)', (id, 4))

    def create_programmable_parameters_VOO(self, id, c): # create programmable parameters for new user
        c.execute('INSERT INTO VOO_lower_rate_limit (id, value) VALUES (?, ?)', (id, 60))
        c.execute('INSERT INTO VOO_upper_rate_limit (id, value) VALUES (?, ?)', (id, 120))
        c.execute('INSERT INTO VOO_ventricular_amplitude (id, value) VALUES (?, ?)', (id, 35))
        c.execute('INSERT INTO VOO_ventricular_pulse_width (id, value) VALUES (?, ?)', (id, 4))


    def create_programmable_parameters_AAI(self, id, c): # create programmable parameters for new user
        c.execute('INSERT INTO AAI_lower_rate_limit (id, value) VALUES (?, ?)', (id, 60))
